...
def get_dataset(args, mode, dataset, path):
    assert dataset.lower() in ['constraint', 'coaid', 'fakecovid', 'antivax', 'liar', 'fever',
        'fakenews', 'gettingreal', 'pheme', 'health', 'gossipcop', 'gossipcop_styled_based','gossipcop_integration_based',
        'gossipcop_story_based','gossipcop_contend_based','politifact', 'multisource']
    ...
    elif dataset.lower() == 'gossipcop_styled_based':
        return GossipCopStyledBasedDataset(args, mode, path)   
    ...
    elif dataset.lower() == 'gossipcop_contend_based':
        return GossipCopContendDataset(args,mode,path)
...
class GossipCopContendDataset(AbstractDataset):
    @classmethod
    def code(cls):
        return 'gossipcop_contend_based'
...
class GossipCopStyledBasedDataset(AbstractDataset):
    @classmethod
    def code(cls):
        return 'gossipcop_styled_based'
